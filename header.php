...
<header class="header">
    ...
    <div class="flex">
        ...
        <a href="home.php" class="logo">FloSerene</a>
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="#" class="fas fa-bars"></a>
                    <ul>
                        <li><a href="anniversary.php">Anniversary</a></li>
                        <li><a href="birthday.php">Birthday</a></li>
                        <li><a href="combos.php">Combos</a></li>
                        <li><a href="love.php">Love and Affection</a></li>
                        <li><a href="shop.php">Weekly Specials!</a></li>
                    </ul>
                </li>
